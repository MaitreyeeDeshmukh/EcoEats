...
import { signUpWithEmail, signInWithGoogle, getAuthErrorMessage } from '../services/auth'
      ...
      <div className="flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-sm">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-neutral-500">Join thousands making smarter food choices</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            ...
            <div className="relative">
              <Input
                ...
                helper="At least 8 characters including one number"
